    ...
    <script>
        ...
        function buscarGraficoMensal(){
            ...
            $.ajax({
                ...
                url:"{{route('patio.grafico.mensal')}}",
                success:function(r){
                    dadosLucroMensal = {
                        "labels": [
                            "LUCRO",
                        ...
                        "datasets": [
                            {
                            "label": "LUCROS X GASTOS",
                            "backgroundColor": ["#00FF7F" , "#A52A2A"],
                            "fill": false,
                            "data": [""+r[0]['LUCRO']+""
                                         ,""+r[0]['GASTOS']+""],
                            "borderColor": "#000000",
